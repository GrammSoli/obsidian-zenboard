...
# Dashboard <% tp.date.now("YYYY") %>

<div class="dashboard-header">
<div class="dashboard-info">
  <div class="dashboard-clock"><% tp.date.now("HH:mm:ss") %></div>
  <div class="dashboard-date"><% tp.date.now("dddd, DD MMMM YYYY") %></div>
</div>
</div>

> *Планы и цели <%= tp.date.now("YYYY") %>* 🚀
